...
//==============================================================================================
//  1) DESCRIPTION
//    FormPopup — modal wrapper: renders the question answers <Form> inside <MyPopup>, closing the
...
import Form from '@/src/ui/admin/questions/answers/form'
...
export default function FormPopup({ record, isOpen, onClose }: Props) {
  return (
    <MyPopup isOpen={isOpen} onClose={onClose} overrideClass='max-w-2xl'>
