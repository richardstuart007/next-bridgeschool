...
import { Action } from '@/src/ui/admin/owner/form-action'
...
export default function Form({ onSuccess, shouldCloseOnUpdate = true }: FormProps) {
  ...
  //
  const [ow_owner, setow_owner] = useState('')
  //-------------------------------------------------------------------------
  //  Update MyButton
  //-------------------------------------------------------------------------
  ...
  return (
    <form action={formAction} className='space-y-3 '>
      <div className='flex-1 rounded-lg bg-gray-50 px-4 pb-2 pt-2 max-w-md'>
        ...
        {/*  ...................................................................................*/}
        <div className='mt-2'>
          <label className='text-xs mb-1 mt-5' htmlFor='ow_owner'>
            Owner
          </label>
          <div className='relative'>
            <MyInput
              ...
              name='ow_owner'
              value={ow_owner}
              onChange={e => setow_owner(e.target.value.replace(/\s+/g, ''))}
            />
          </div>
        </div>
        {/*   Errors */}
        <div id='fedid-error' aria-live='polite' aria-atomic='true'>
          {formState.errors?.ow_owner &&
            formState.errors.ow_owner.map((error: string) => (
