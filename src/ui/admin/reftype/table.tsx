...
//==============================================================================================
//  1) DESCRIPTION
//    Table — paginated, per-column-filtered admin list of trt_reftype (reftypes). Server-side
...
import FormPopup from '@/src/ui/admin/reftype/formPopup'
...
export default function Table({ initialRows, initialTotalPages }: TableProps = {}) {
  ...
  const [record, setrecord] = useState<table_Reftype[]>(initialRows ?? [])
