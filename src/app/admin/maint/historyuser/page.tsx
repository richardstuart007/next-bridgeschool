//==============================================================================================
//  1) DESCRIPTION
//    Page — /admin/maint/historyuser: like /history but scoped to the signed-in user
//    (fetch_SessionInfo -> si_usid), pre-selecting the user's owner when they have exactly one.
//==============================================================================================
...
export default async function Page() {
  const functionName = 'AdminHistoryUserPage'
